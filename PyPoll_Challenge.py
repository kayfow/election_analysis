...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        countytotal_votes = countytotal_votes + 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_dict:
        ...
        countyvote_percentage = float(countyvotes)/float(countytotal_votes) * 100
        county_results = (
    ...
    winning_county_summary = (
            f"-------------------------\n"
            f"County Turnout: {winning_county_turnout}\n"
            f"Total County Votes: {winning_county_votes:,}\n"
...
# DELIVERABLE 2 FORMATTING REQUIREMENTS
